    ...
    <section id="rooms" className="py-24 bg-background relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="relative rounded-[3rem] overflow-hidden border border-primary/20 shadow-2xl">
          ...
          <div className="relative z-10 h-[500px] w-full p-8 md:p-12 overflow-y-auto no-scrollbar">
        ...
        <div className="mt-10 flex justify-center">
          <p className="text-foreground/20 text-[10px] font-black uppercase tracking-[0.5em] animate-pulse">Scroll to explore the pyramid</p>
        </div>
      </div>
    </section>
  );
